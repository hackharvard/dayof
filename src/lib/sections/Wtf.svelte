<div class="min-h-screen bg-secondary p-8 text-white">
  <div class="mx-auto max-w-4xl">
    ...
    <img src="images/2022/merch.jpg" alt="Merch Image" class="mb-6 rounded-lg shadow-lg" />

    <img src="images/2022/food.jpg" alt="Food Image" class="mb-6 rounded-lg shadow-lg" />
    ...
    <img src="images/2022/mentors.jpg" alt="Mentor Image" class="mb-6 rounded-lg shadow-lg" />
    ...
    <img src="images/2022/speaker.jpg" alt="Speaker Image" class="mb-6 rounded-lg shadow-lg" />
    ...
    <img src="images/2022/friends.jpg" alt="Networking Image" class="mb-6 rounded-lg shadow-lg" />
